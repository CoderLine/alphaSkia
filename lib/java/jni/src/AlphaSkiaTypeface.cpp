...
extern "C"
{
    ...
    JNIEXPORT jboolean JNICALL Java_net_alphatab_alphaskia_AlphaSkiaTypeface_isBold(JNIEnv *env, jobject instance)
    {
    ...
    JNIEXPORT jboolean JNICALL Java_net_alphatab_alphaskia_AlphaSkiaTypeface_isItalic(JNIEnv *env, jobject instance)
    {
        jlong handle = get_handle(env, instance);
    ...
    JNIEXPORT jstring JNICALL Java_net_alphatab_alphaskia_AlphaSkiaTypeface_loadFamilyName(JNIEnv *env, jclass, jlong handle)
    {
