...
public class AlphaTabGeneratedRenderTest extends MusicSheetRenderTest
{
    ...
    {
        canvas.beginRender((int)1300, (int)164, (float)getRenderScale());
    ...
    {
        canvas.beginRender((int)1300, (int)38, (float)getRenderScale());
        setTextAlign(AlphaSkiaTextAlign.CENTER);
    ...
    {
        canvas.beginRender((int)1300, (int)6, (float)getRenderScale());
        setTextAlign(AlphaSkiaTextAlign.CENTER);
        return canvas.endRender();
    }
    private AlphaSkiaImage drawMusicSheetPart4(AlphaSkiaCanvas canvas)
    {
        canvas.beginRender((int)1300, (int)373, (float)getRenderScale());
        setTextAlign(AlphaSkiaTextAlign.LEFT);
    ...
    {
        canvas.beginRender((int)116.07421875, (int)24, (float)getRenderScale());
        canvas.setColor(AlphaSkiaCanvas.rgbaToColor((byte)0, (byte)0, (byte)0, (byte)255));
    ...
    @Override
    protected float[][] getPartPositions()
    {
        return new float[][]
        {
    ...
    @Override
    protected int getTotalWidth() { return (int)1300; }
    @Override
    protected int getTotalHeight() { return (int)605; }
    @Override
    protected RenderFunction[] getAllParts()
    {
        return new RenderFunction[]
        {
            this::drawMusicSheetPart1, this::drawMusicSheetPart2, this::drawMusicSheetPart3, this::drawMusicSheetPart4, this::drawMusicSheetPart5
        };
    }
}
