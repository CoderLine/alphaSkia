...
extern "C"
{
    JNIEXPORT jlong JNICALL Java_alphaTab_alphaSkia_NativeMethods_alphaskiaTypefaceRegister(JNIEnv * env, jclass clz, jlong data)
    {
    ...
    JNIEXPORT void JNICALL Java_alphaTab_alphaSkia_NativeMethods_alphaskiaTypefaceFree(JNIEnv * env, jclass clz, jlong handle)
    {
        alphaskia_typeface_free(reinterpret_cast<alphaskia_typeface_t>(handle));
    }

    JNIEXPORT jlong JNICALL Java_alphaTab_alphaSkia_NativeMethods_alphaskiaTypefaceMakeFromName(JNIEnv * env, jclass clz, jstring name, jboolean bold, jboolean italic)
    {
    ...
    JNIEXPORT jstring JNICALL Java_alphaTab_alphaSkia_NativeMethods_alphaskiaTypefaceGetFamilyName(JNIEnv * env, jclass clz, jlong handle)
    {
    ...
    JNIEXPORT jboolean JNICALL Java_alphaTab_alphaSkia_NativeMethods_alphaskiaTypefaceIsBold(JNIEnv * env, jclass clz, jlong handle)
    {
    ...
    JNIEXPORT jboolean JNICALL Java_alphaTab_alphaSkia_NativeMethods_alphaskiaTypefaceIsItalic(JNIEnv * env, jclass clz, jlong handle)
    {
