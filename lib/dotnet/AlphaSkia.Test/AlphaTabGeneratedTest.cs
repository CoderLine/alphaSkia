...
public class AlphaTabGeneratedRenderTest : MusicSheetRenderTest
{
    ...
    {
        canvas.BeginRender((int)1300, (int)164, (float)RenderScale);
    ...
    {
        canvas.BeginRender((int)1300, (int)38, (float)RenderScale);
        TextAlign = AlphaSkiaTextAlign.Center;
    ...
    {
        canvas.BeginRender((int)1300, (int)6, (float)RenderScale);
        TextAlign = AlphaSkiaTextAlign.Center;
        return canvas.EndRender();
    }
    private AlphaSkiaImage DrawMusicSheetPart4(AlphaSkiaCanvas canvas)
    {
        canvas.BeginRender((int)1300, (int)373, (float)RenderScale);
        TextAlign = AlphaSkiaTextAlign.Left;
    ...
    {
        canvas.BeginRender((int)116.07421875, (int)24, (float)RenderScale);
        canvas.Color = AlphaSkiaCanvas.RgbaToColor((byte)0, (byte)0, (byte)0, (byte)255);
    ...
    protected override float[,] PartPositions => new float[,] {
    {(float)0, (float)0}, {(float)0, (float)164}, {(float)0, (float)202}, {(float)0, (float)208}, {(float)591.962890625, (float)581}
        };
    protected override int TotalWidth => (int)1300;
    protected override int TotalHeight => (int)605;
    protected override Func<AlphaSkiaCanvas, AlphaSkiaImage>[] AllParts => new[]
    {
